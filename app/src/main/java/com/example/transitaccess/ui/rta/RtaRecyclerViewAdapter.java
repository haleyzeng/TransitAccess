...
public class RtaRecyclerViewAdapter extends RecyclerView.Adapter<RtaRecyclerViewAdapter.ViewHolder> {
    private List<RouteDesc> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    // data is passed into the constructor
    RtaRecyclerViewAdapter(Context context, List<RouteDesc> data) {
